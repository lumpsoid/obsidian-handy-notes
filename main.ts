import { App, FuzzyMatch, FuzzySuggestModal, TFile, Notice, Plugin, PluginSettingTab, Setting, MarkdownView, moment, Setting, sortSearchResults, prepareSimpleSearch } from 'obsidian';
...
export default class MyPlugin extends Plugin {
	...
	async onload() {
		...
		const ribbonRefresh = this.addRibbonIcon(
			'refresh-ccw',
			'exampl reload',
			(evt: MouseEvent) => {
